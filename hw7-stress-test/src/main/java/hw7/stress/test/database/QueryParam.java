package hw7.stress.test.database;
...
public class QueryParam {
    ...
    public static QueryParam getBooleanNull() {
        return new QueryParam(Types.BOOLEAN, null);
    }

    public static QueryParam getFloatNull() {
        return new QueryParam(Types.FLOAT, null);
    }
